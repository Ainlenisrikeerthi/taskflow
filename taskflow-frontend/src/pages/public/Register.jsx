    ...
    <main className="auth-page">
      <div className="auth-card">
        ...
        <header className="auth-header">
          ...
          <p className="auth-subtitle">Join TaskFlow and keep every task on track.</p>
        </header>
        ...
        <form className="auth-form" onSubmit={handleRegister}>
          ...
          <Input
            ...
            error={isPasswordMismatch ? "Passwords must match" : undefined}
            suffix={isPasswordMismatch ? <AlertTriangle size={16} color="#DC2626" /> : undefined}
            required
            disabled={isLoading}
            autoComplete="new-password"
          />
